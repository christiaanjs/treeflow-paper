...
\response{\done\ We now show Monte Carlo error estimates for the BEAST density plots. %TODO: confirm figures regenerated
}
...
\response{\done\ Same approach as Fig.~2. %TODO: confirm figures regenerated
}
...
\response{\done %TODO: confirm figure regenerated
}
