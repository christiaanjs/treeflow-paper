...
\author{\BLOCK{block author}\BLOCK{endblock}\\[4pt]
    ...
    \textit{\BLOCK{block correspondence}\BLOCK{endblock}}}


% Running headers of paper:
\markboth%
% First field is the short list of authors
{\BLOCK{block authorshortlist}\BLOCK{endblock}}
% Second field is the short title of the paper
{\BLOCK{block shorttitle}\BLOCK{endblock}}
...
\begin{abstract}
    ...
    {\BLOCK{block keywords}\BLOCK{endblock}}
\end{abstract}
\newline
